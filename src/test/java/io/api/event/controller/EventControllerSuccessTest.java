        ...
        resultActions.andDo(print())
                ...
                .andDo(document("create-event",
                        ...
                        requestFields(
                                ...
                                fieldWithPath("beginEnrollmentDateTime").description("Date time of begin enrollment of new event").attributes(getDateTimeFormat()),
                                fieldWithPath("closeEnrollmentDateTime").description("Date time of close enrollment of new event").attributes(getDateTimeFormat()),
                                fieldWithPath("beginEventDateTime").description("Date time of begin of new event").attributes(getDateTimeFormat()),
                                fieldWithPath("endEventDateTime").description("Date time of close of new event").attributes(getDateTimeFormat()),
