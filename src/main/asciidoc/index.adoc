...
operation::create-event[snippets='curl-request,http-request,request-headers,request-body,request-fields,http-response,response-headers,response-fields,links']
...
operation::get-an-event[snippets='curl-request,http-request,request-headers,path-parameters,http-response,response-headers,response-body,response-fields,links']
...
operation::get-event-list[snippets='response-fields,curl-request,http-response,links']
